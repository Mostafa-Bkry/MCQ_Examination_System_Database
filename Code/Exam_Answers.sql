...
Create view showQuesWithAns (examID, Question, AnsLetter, Answer, TorF)
as
	Select ex.exam_id, q.question, qa_letter, qa_answer, qa_isTrue
...
as
	...
	open C1
	fetch C1 into @Question, @qa_letter, @qa_answer, @qa_isTrue
